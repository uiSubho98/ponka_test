...
const Support = () => {
  return (
    ...
    <div className="mb-8 lg:text-center md:text-center sm:mb-12 ">
      ...
      <p className="font-semibold sm:mt-1 mt-2 text-[1.15rem] lg:text-[0.9rem] md:text-[0.75rem] sm:text-[1rem]">We welcome your inquiries, contributions, and partnership opportunities as we strive to make <span className="sm:block md:hidden">  a meaningful difference in the lives of those we serve.</span> </p>
      <p className="font-semibold sm:mt-1 mt-2 text-[1.15rem] lg:text-[0.9rem] md:text-[0.75rem] sm:text-[1rem] hidden sm:block" > a meaningful difference in the lives of those we serve.</p>
    </div>
    <div className="text-center  sm:mx-[24%] lg:mx-[35%] mx-[2%] px-[2%] lg:px-0 py-[5%] text-[1rem] bg-[#FCF9F9] ring-1 ring-[#DAE8F0] rounded-md">
